...
<body>
    ...
    <div class="container">
        <header style="margin-bottom: 20px;">
            <a href="index.php" style="text-decoration: none; color: #10b981; font-weight: 600;">← Esplora
                Inserzioni</a>
        </header>
        ...
        <div class="profile-card">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="text-align: right;">
                    ...
                    <div style="font-size: 14px; color: #9ca3af;"><?php echo $feedback['num'];
                    [cite_start] ?> recensioni
                        ricevute [cite: 64]</div>
                </div>
            </div>
                ...
                <?php while ($ins = $inserzioni->fetch_assoc()): ?>
                    <a href="inserzione.php?id=<?php echo $ins['idInserzione']; ?>" class="ins-item">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="font-size: 13px; color: #6b7280;"><?php echo $ins['pesoComplessivo'];
                            [cite_start] ?>g
                                complessivi [cite: 15, 43]</span>
                        </div>
                    </a>
                <?php endwhile; ?>
            <?php else: ?>
                <p
                    style="color: #9ca3af; grid-column: span 2; text-align: center; padding: 40px; background: #fff; border-radius: 12px; border: 1px dashed #d1d5db;">
