        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <?php if (isset($_SESSION['username'])): ?>
                    ...
                    <a href="vendita-sapone.php" style="color: #28a745; font-weight: bold; border-bottom: 1px solid #eee; display: flex; align-items: center;">
                    Vendi un sapone</a>
                    <a href="dashboard.php">La mia dashboard</a>
                    <a href="indirizzi.php">I miei indirizzi</a>
                    <a href="settings.php">Impostazioni</a>
                    <a href="db/logout-process.php" class="logout-link" style="text-align: center">Logout</a>
                <?php else: ?>
